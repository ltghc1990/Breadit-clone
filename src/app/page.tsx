import CustomFeed from "@/components/CustonFeed";
    ...
    <>
      ...
      <div className="grid grid-cols-1 py-6 md:grid-cols-3 gap-y-4 md:gap-x-4">
        ...
        <div className="order-first overflow-hidden border border-gray-200 rounded-lg h-fit md:order-last">
          <div className="px-5 py-4 bg-emerald-100">
          ...
          <div className="px-6 py-4 -my-3 text-sm leading-6 divide-y divide-gray-800">
            ...
            <Link
              className={buttonVariants({ className: "w-fill mt-4 mb-6" })}
              href="/r/create"
            >
              Create Community
            </Link>
